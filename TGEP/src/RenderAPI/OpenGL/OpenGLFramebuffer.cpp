...
namespace TGEP
{
	OpenGLFramebuffer::OpenGLFramebuffer(FramebufferSettings settings)
		:m_Settings(settings)
	{
		Invalidate();
	}
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		ASSERT_CORE(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer not complete");
