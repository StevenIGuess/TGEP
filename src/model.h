...
private:
    unsigned int getVoneId(const aiBone* bone);
    ...
    Mesh processMesh(aiMesh *mesh, const aiScene *scene)
    {
        ...
        std::cout <<   "Processing Mesh " << mesh->mName.C_Str() << " with " << mesh->mNumVertices << " Vertecies, " << mesh->mNumFaces << " Faces and " << mesh->mNumBones << " Bones;\n" << std::endl;
...
unsigned int TextureFromFile(const char *path, const string &directory, bool gamma)
{
    ...
    filename = "..\\resources\\backpack\\" + filename;
